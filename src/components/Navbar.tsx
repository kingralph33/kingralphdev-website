      ...
      <div className="max-w-screen mx-auto px-6">
        <div className="flex justify-between items-center h-16">
          <div className="flex-shrink-0">
            <Link to="/" className="text-xl font-semibold font-sans">KingRalph.dev</Link>
          </div>
          <div className="flex space-x-4 items-center">
            <Link to="/about" className="text-[oklch(0.32_0.03_270.43)] hover:text-gray-900">About</Link>
            <Link to="/resume" className="text-[oklch(0.32_0.03_270.43)] hover:text-gray-900">Resume</Link>
            <a 
