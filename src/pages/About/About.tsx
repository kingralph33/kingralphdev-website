    ...
    <div className="max-w-4xl mx-auto px-4 py-6 lg:py-10">
      ...
      <div className="flex flex-col items-center mb-8">
        <img
          ...
          width="150"
          height="150"
          className="w-32 h-32 lg:w-36 lg:h-36 rounded-full object-cover mb-4 border-4 border-[--color-grinch-green]"
          loading="eager"
        />
        <h1 className="text-2xl lg:text-3xl font-bold mb-3 text-center text-[--color-navy-blue] dark:text-white">
          About Me
        </h1>
      </div>

      {/* Career Transition Story - Prominently Featured */}
      <div className="bg-gray-100 dark:bg-gray-800 p-5 lg:p-6 rounded-lg mb-8 border-l-4 border-[--color-grinch-green]">
        <h2 className="text-xl lg:text-2xl font-bold mb-4 text-center text-[--color-navy-blue] dark:text-white">
          From Banking to Building Government Systems
        </h2>
        <p className="text-sm lg:text-base text-gray-700 dark:text-white dark:font-semibold text-left md:text-justify leading-relaxed mb-3">
        ...
        <p className="text-sm lg:text-base text-gray-700 dark:text-white dark:font-semibold text-left md:text-justify leading-relaxed">
      ...
      <p className="text-sm lg:text-base text-gray-700 dark:text-white dark:font-semibold text-left md:text-justify leading-relaxed mb-4">
      ...
      <p className="text-sm lg:text-base text-gray-700 dark:text-white dark:font-semibold text-left md:text-justify leading-relaxed mb-8">
      ...
      <div className="bg-gray-100 dark:bg-gray-800 p-5 lg:p-6 rounded-lg mb-8 border-l-4 border-[--color-grinch-green]">
        ...
        <p className="text-sm lg:text-base text-gray-700 dark:text-white dark:font-semibold text-left md:text-justify leading-relaxed mb-3">
          Above all, I'm a husband to my wonderful wife and a father to my daughter, who is a true blessing. Family is my foundation, and they're the reason I strive to be better every day.
        </p>
        <p className="text-sm lg:text-base text-gray-700 dark:text-white dark:font-semibold text-left md:text-justify leading-relaxed mb-3">
      ...
      {/* Divider */}
      <hr className="border-[--color-grinch-green] border-2 mb-8" />

      {/* Three Column Section */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* Left Column */}
        <div className="text-center">
          <h2 className="text-base lg:text-lg font-bold mb-3 text-[--color-navy-blue] dark:text-white">
            Technical Interests
          </h2>
