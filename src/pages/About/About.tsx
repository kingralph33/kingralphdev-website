...
```
  ...
  <div className="bg-gray-50 dark:bg-gray-800 p-6 lg:p-8 rounded-lg mb-12">
    ...
    <p className="text-lg lg:text-xl xl:text-2xl text-gray-700 dark:text-gray-200 text-left leading-relaxed mb-4">
    ...
    <p className="text-lg lg:text-xl xl:text-2xl text-gray-700 dark:text-gray-200 text-left leading-relaxed">
  ...
  <p className="text-lg lg:text-xl xl:text-2xl text-gray-700 dark:text-gray-200 text-left leading-relaxed mb-6">
  ...
  <p className="indent-6 lg:indent-10 xl:indent-14 text-lg lg:text-xl xl:text-2xl text-gray-700 dark:text-gray-200 text-left leading-relaxed mb-6">
  ...
  <p className="indent-6 lg:indent-10 xl:indent-14 text-lg lg:text-xl xl:text-2xl text-gray-700 dark:text-gray-200 text-left leading-relaxed mb-2">
  ...
  <p className=" indent-6 lg:indent-10 xl:indent-14 text-lg lg:text-xl xl:text-2xl text-gray-700 dark:text-gray-200 text-left leading-relaxed mb-12">
